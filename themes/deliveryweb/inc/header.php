    ...
    <div class="rd-navbar-wrap rd-navbar-modern-wrap">
        ...
        <div class="rd-navbar-main-outer">
            ...
            <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a class="brand" href="<?= url("/")?>"><img src="<?= image(theme("assets/images/logo-default-196x47.png"), 196, 47) ?>" alt="<?= CONF_SITE_NAME ?>" width="196" height="47"/></a></div>
            </div>
            <div class="rd-navbar-main-element">
                ...
                <div class="rd-navbar-basket-wrap">
                    ...
                    <div class="cart-inline-header">
                        <h5 class="cart-inline-title">Carrinho:<span> 2</span> Produto(s)</h5>
                    ...
                    <div class="cart-inline-body">
                        ...
                        <div class="unit align-items-center">
                            ...
                            <div>
                                ...
                                <h6 class="cart-inline-title">R$ 550,00</h6>
                                </div>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="cart-inline-footer">
                        <div class="group-sm"><a class="button button-md button-default-outline-2 button-wapasha" href="#">Carrinho</a><a class="button button-md button-primary button-pipaluk" href="#">Finalizar</a></div>
                    </div>
                    </div>
                ...
                <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="<?= url("sobre")?>">Sobre</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="<?= url("contato")?>">Contato</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="<?= url("entrar")?>">Login</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="<?= url("cadastrar")?>">Cadastre-se</a>
                    </li>
                </ul>
                </div>
            ...
            <div class="rd-navbar-project rd-navbar-modern-project">
                ...
                <div>
                    ...
                    <li>
                        ...
                        <div class="unit-body"><a target="_blank" class="link-phone" href="https://api.whatsapp.com/send/?phone=<?= CONF_SITE_WHATSAPP_NUMBER ?>"><?= CONF_SITE_WHATSAPP_FMT ?></a></div>
                        </div>
                    </li>
                    <li>
                        <div class="unit unit-spacing-sm">
                        <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                        <div class="unit-body"><a class="link-location" href="#"><?= CONF_SITE_ADDR_STREET.", Nº ".CONF_SITE_ADDR_NUMBER.", ".CONF_SITE_ADDR_COMPLEMENT.", ".CONF_SITE_ADDR_CITY, " - ".CONF_SITE_ADDR_STATE.", ".CONF_SITE_ADDR_ZIPCODE ?></a></div>
                        </div>
                    </li>
                    <li>
                        <div class="unit unit-spacing-sm">
                        <div class="unit-left"><span class="icon fa fa-envelope"></span></div>
                        <div class="unit-body"><a class="link-email" href="mailto:<?= CONF_SITE_EMAIL ?>"><?= CONF_SITE_EMAIL ?></a></div>
                        </div>
                    </li>
                    </ul>
